...
{ 
  ...
  { 
    ...
    constAmbName1 = termFactory.makeAppl(transform._consAmbName_1, new IStrategoTerm[]{cool.constId9});
    ...
    constMethodName1 = termFactory.makeAppl(transform._consMethodName_2, new IStrategoTerm[]{cool.constAmbName1, cool.constId10});
    constMethod1 = termFactory.makeAppl(transform._consMethod_1, new IStrategoTerm[]{cool.constMethodName1});
    constInvoke0 = termFactory.makeAppl(transform._consInvoke_2, new IStrategoTerm[]{cool.constMethod1, cool.constNil0});
    constCons7 = (IStrategoTerm)termFactory.makeListCons(cool.constInvoke0, (IStrategoList)cool.constNil0);
    constInvoke1 = termFactory.makeAppl(transform._consInvoke_2, new IStrategoTerm[]{cool.constMethod0, cool.constCons7});
    constNot0 = termFactory.makeAppl(transform._consNot_1, new IStrategoTerm[]{cool.constInvoke1});
    constSome0 = termFactory.makeAppl(transform._consSome_1, new IStrategoTerm[]{cool.constNot0});
    ...
    constAmbName2 = termFactory.makeAppl(transform._consAmbName_1, new IStrategoTerm[]{cool.constId11});
    ...
    constMethodName2 = termFactory.makeAppl(transform._consMethodName_2, new IStrategoTerm[]{cool.constAmbName2, cool.constId12});
    ...
    constTypeName3 = termFactory.makeAppl(transform._consTypeName_1, new IStrategoTerm[]{cool.constId13});
    ...
    constInvoke2 = termFactory.makeAppl(transform._consInvoke_2, new IStrategoTerm[]{cool.constMethod2, cool.constCons9});
    const38 = termFactory.makeString("State");
    constCons10 = (IStrategoTerm)termFactory.makeListCons(cool.const38, (IStrategoList)cool.constNil0);
    ...
    constId14 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const42});
    constTypeName4 = termFactory.makeAppl(transform._consTypeName_1, new IStrategoTerm[]{cool.constId14});
    ...
    constTypeName5 = termFactory.makeAppl(transform._consTypeName_1, new IStrategoTerm[]{cool.constId16});
    ...
    constElemValPair0 = termFactory.makeAppl(transform._consElemValPair_2, new IStrategoTerm[]{cool.constId15, cool.constLit4});
    ...
    constTypeName6 = termFactory.makeAppl(transform._consTypeName_1, new IStrategoTerm[]{cool.constId24});
    ...
    constTypeName7 = termFactory.makeAppl(transform._consTypeName_1, new IStrategoTerm[]{cool.constId25});
    const54 = termFactory.makeString("util");
    constId26 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const54});
    constCons12 = (IStrategoTerm)termFactory.makeListCons(cool.constId26, (IStrategoList)cool.constNil0);
    constId27 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const27});
    constCons13 = (IStrategoTerm)termFactory.makeListCons(cool.constId27, (IStrategoList)cool.constCons12);
    ...
    constCons15 = (IStrategoTerm)termFactory.makeListCons(cool.constId28, (IStrategoList)cool.constNil0);
    const56 = termFactory.makeString("cool");
    constId29 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const56});
    constCons16 = (IStrategoTerm)termFactory.makeListCons(cool.constId29, (IStrategoList)cool.constCons15);
    ...
    constId30 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const59});
    ...
    constId31 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const60});
    const61 = termFactory.makeString("notifyAll");
    constId32 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const61});
    constMethodName3 = termFactory.makeAppl(transform._consMethodName_1, new IStrategoTerm[]{cool.constId32});
    constMethod3 = termFactory.makeAppl(transform._consMethod_1, new IStrategoTerm[]{cool.constMethodName3});
    constInvoke3 = termFactory.makeAppl(transform._consInvoke_2, new IStrategoTerm[]{cool.constMethod3, cool.constNil0});
    constExprStm0 = termFactory.makeAppl(transform._consExprStm_1, new IStrategoTerm[]{cool.constInvoke3});
    ...
    constMethodName4 = termFactory.makeAppl(transform._consMethodName_1, new IStrategoTerm[]{cool.constId5});
    ...
    constId33 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const67});
    constMethodName5 = termFactory.makeAppl(transform._consMethodName_1, new IStrategoTerm[]{cool.constId33});
    constMethod5 = termFactory.makeAppl(transform._consMethod_1, new IStrategoTerm[]{cool.constMethodName5});
    constInvoke4 = termFactory.makeAppl(transform._consInvoke_2, new IStrategoTerm[]{cool.constMethod5, cool.constNil0});
    constExprStm1 = termFactory.makeAppl(transform._consExprStm_1, new IStrategoTerm[]{cool.constInvoke4});
    ...
    constId34 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const68});
    ...
    constId35 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const69});
    ...
    constReturn1 = termFactory.makeAppl(transform._consReturn_1, new IStrategoTerm[]{cool.constNone0});
    constCons22 = (IStrategoTerm)termFactory.makeListCons(cool.constReturn1, (IStrategoList)cool.constNil0);
    ...
    constId36 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const70});
    const71 = termFactory.makeString("COOLLock");
    constId37 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const71});
    ...
    constId38 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const75});
    constTypeName11 = termFactory.makeAppl(transform._consTypeName_1, new IStrategoTerm[]{cool.constId38});
    constMarkerAnno0 = termFactory.makeAppl(transform._consMarkerAnno_1, new IStrategoTerm[]{cool.constTypeName11});
    ...
    constId39 = termFactory.makeAppl(transform._consId_1, new IStrategoTerm[]{cool.const77});
    constTypeName12 = termFactory.makeAppl(transform._consTypeName_1, new IStrategoTerm[]{cool.constId39});
    constMarkerAnno1 = termFactory.makeAppl(transform._consMarkerAnno_1, new IStrategoTerm[]{cool.constTypeName12});
